 ...
 */
final class Version20230411145927 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE replies (id CHAR(36) NOT NULL, bot_id CHAR(36) DEFAULT NULL, type VARCHAR(255) NOT NULL, content_id INT UNSIGNED NOT NULL, container_id INT UNSIGNED NOT NULL, content LONGTEXT NOT NULL, response LONGTEXT DEFAULT NULL, created_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', processed_at DATETIME DEFAULT NULL COMMENT \'(DC2Type:datetime_immutable)\', published_at DATETIME DEFAULT NULL COMMENT \'(DC2Type:datetime_immutable)\', INDEX IDX_A000672A92C1C487 (bot_id), INDEX idx_id (id), UNIQUE INDEX idx_content_id_type (content_id, type), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
